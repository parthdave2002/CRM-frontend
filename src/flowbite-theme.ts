...
const flowbiteTheme: CustomFlowbiteTheme = {
  ...
  button: {
    color: {
      primary:
        "text-black bg-blue-100 hover:bg-primary-300 focus:ring-primary-300 dark:bg-blue-100 dark:hover:bg-primary-300 dark:focus:ring-primary-800",
    },
    outline: {
  ...
  sidebar: {
    base: "flex fixed left-0 z-20 flex-col flex-shrink-0  bg-green-500 h-full duration-75 border-r border-gray-200 lg:flex transition-width dark:bg-gray-800 dark:border-gray-700",
  },
  textarea: {
